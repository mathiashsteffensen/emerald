...
const NAME: &str = "NilClass";

lazy_static! {
    pub static ref EM_NIL: Arc<EmeraldObject> = em_instance();
}
...
pub fn em_instance() -> Arc<EmeraldObject> {
    EmeraldObject::new_instance_with_underlying_value(NAME, UnderlyingValueType::Nil)
}
