	...
	tests := []compilerTestCase{
		...
		},
		{
			...
			expectedInstructions: []bytecode.Instructions{
				...
				bytecode.Make(bytecode.OpPushConstant, 10),
				bytecode.Make(bytecode.OpNull),
				bytecode.Make(bytecode.OpSend),
				bytecode.Make(bytecode.OpPushConstant, 11),
				bytecode.Make(bytecode.OpNull),
		...
		},
		{
			...
			expectedInstructions: []bytecode.Instructions{
				...
				bytecode.Make(bytecode.OpPushConstant, 9),
				bytecode.Make(bytecode.OpNull),
				bytecode.Make(bytecode.OpSend, 0),
				bytecode.Make(bytecode.OpPop),
		...
		},
		{
			...
			expectedInstructions: []bytecode.Instructions{
				...
				bytecode.Make(bytecode.OpSend, 2, 1),
				bytecode.Make(bytecode.OpPop),
			},
		},
	}
